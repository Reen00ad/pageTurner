...
## My Endpoints :
### 1. Follow For Writer
### 2. Unfollow For writer
### 3. Search writer by name
### 4. Add publish genre for writer
### 5. Get meeting code
### 6. Get event code
### 7. Reader join event
### 8. Reader join meeting
### 9. Reader leave even
### 10. Reader leave meeting
### 11. Get books by genre
### 12. Add preferred genre for reader
### 13. Get all post by user
### 14. Get top 5 posts for a book
### 15. Get all post by book name
### 16. Change goal status 
## Model :
### 1. Event - CRUD
### 2. Reader - CRUD
### 3. Meeting - CRUD
